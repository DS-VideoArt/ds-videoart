/* ============================================================
   DS VideoArt: room-specific client logic
   Loaded after ../ds-shared.js, which supplies qs/qsa/escHtml/
   fetchJSON/getLang/setLang/applyStaticLang/initLang/initNav/
   initReveals/addPageListener/onLangChange/clearLangChangeHandlers/
   scrollToHash/prefersReducedMotion and the DOMContentLoaded boot.
   Everything below is specific to VideoArt's own content: the
   portfolio film-strip, AI blog, single-post view, lightbox, the
   countdown intro, and the quote form.
   ============================================================ */
